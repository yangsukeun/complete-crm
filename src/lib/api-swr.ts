...
export const SWR_KEYS = {
  ...
  /** 스케줄(/schedule): 할일 UI·레거시(UNKNOWN)만 — 마인드맵·프로젝트 자동 생성 제외 */
  scheduleStandaloneTasks:
    "/api/tasks?projectId=null&status=TODO,IN_PROGRESS&excludeProjectTitleMatch=1&creationSource=SCHEDULE,UNKNOWN",
